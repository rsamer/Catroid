...
public class ScratchProgramDetailsActivityTest extends BaseActivityInstrumentationTestCase<ScratchProgramDetailsActivity> {
	...
	public void testIsTitleViewPresentAndHasCorrectContent() {
		...
		assertEquals(programData.getTitle(), ((TextView) titleView).getText());
	}
	...
	public void testIsOwnerViewPresentAndHasCorrectContent() {
		...
		assertEquals(getActivity().getString(R.string.by_x, programData.getOwner()), ((TextView) ownerView).getText());
	}
	...
	public void testIsInstructionsViewPresentAndHasCorrectContent() {
		...
		assertEquals(programData.getInstructions(), ((FlowTextView) instructionsView).getText());
	}
	...
	public void testIsNotesAndCreditsViewPresentAndHasCorrectContent() {
		...
		assertEquals(programData.getNotesAndCredits(), ((TextView) notesAndCreditsView).getText());
	}
	...
	public void testIsSharingViewPresentAndHasCorrectContent() {
		...
		assertEquals(programData.getLoves(), Integer.parseInt(((TextView) lovesLabelView).getText().toString()));
	...
	public void testIsSharedDateViewPresentAndHasCorrectContent() {
		...
		assertEquals(getActivity().getString(R.string.shared_at_x, sharedDateString), sharedDateViewText);
	}
